# Create Function
create_exposure_sql <- function(concept_id, concept_name){ # this should be a RxNorm 
...
"))
  ...
  file_name = paste0(concept_name, ".sql")
...
create_outcome_sql <- function(concept_id, concept_name){ # this should be a Snowmed
...
create_outcome_sql(8941340, "testreaction")
